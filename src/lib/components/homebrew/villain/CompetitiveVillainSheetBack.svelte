...
<div class="relative rounded-[10px] overflow-hidden" style:--scale={scale}>
    <img width={700 * scale} height={566 * scale} src={template.competitive.backBackgroundImage} alt="Competitive Villain Sheet Back">
