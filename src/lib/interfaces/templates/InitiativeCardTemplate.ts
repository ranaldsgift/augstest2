...
export const InitiativeCardTemplates: Record<ThemeTemplatesEnum, InitiativeCardTemplate> = {
    ...
    BTAS: {
        ...
        image: { size: { width: '388px', height: '485px' }, position: { left: '0px', top: '81px' } },
        name: { size: { width: '300px', height: '255px' }, position: { left: '25px', top: '200px' }, font: 'BebasNeueBold', fontSize: 72, fontColor: 'white', classList: "flex text-center justify-end items-center" },
        nameText: { font: 'BebasNeueBold', fontSize: 72, fontColor: 'white',
